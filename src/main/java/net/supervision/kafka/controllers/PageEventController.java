package net.supervision.kafka.controllers;

import net.supervision.kafka.events.PageEvent;
...
public class PageEventController {
    ...
    public PageEvent publish(String name, String topic){
        PageEvent event = new PageEvent(name, Math.random()>0.5?"U1":"U2", new Date(), (long) (10+new Random().nextInt(1000)));
